...
If## if the previous term is odd, the next term is 3 times the previous term plus 1### The conjecture is that no matter what value of n, the sequence will always reach 1. 
def is_even(number):
    return number %  2 ==   0
